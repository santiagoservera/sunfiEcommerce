  ...
  return (
    <header className="w-full z-10 bg-[#2F0F35] border-[1px] border-[#855E98] overflow-hidden">
      <nav className="containerWidth flex flex-wrap justify-between items-center py-4 lg:py-0 text-lg h-20 text-[#d8d8d8] ">
        <div className="text-base text-[#d8d8d8] lg:text-lg font-semibold flex flex-wrap  w-full justify-between items-center">
          ...
          <div className="lg:flex lg:gap-10 lg:mr-10 lg:ml-10 flex flex-row gap-10 items-center md:flex md:flex-row md:justify-between md:w-1/3">
            <div className="md:hidden">
